...
formAddingBook.addEventListener("submit", function (event) {
  ...
  const { value: title } = document.getElementById("inputBookTitle");
  const { value: author } = document.getElementById("inputBookAuthor");
  const { value: year } = document.getElementById("inputBookYear");
